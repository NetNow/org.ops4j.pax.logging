...
public class PaxLoggingServiceImplTest {
    ...
    public void testNullBundleContext() {
    	new PaxLoggingServiceImpl((BundleContext)null, EasyMock.createMock(LogReaderServiceImpl.class), EasyMock.createMock(EventAdminPoster.class));
    }
    @Test(expected=IllegalArgumentException.class)
    public void testNullLogReader() {
    	new PaxLoggingServiceImpl(EasyMock.createMock(BundleContext.class), (LogReaderServiceImpl)null, EasyMock.createMock(EventAdminPoster.class));
    }
    @Test(expected=IllegalArgumentException.class)
    public void testNullEventPoster() {
    	new PaxLoggingServiceImpl(EasyMock.createMock(BundleContext.class), EasyMock.createMock(LogReaderServiceImpl.class), (EventAdminPoster)null);
    }
}
